 ...
 * @copyright Copyright 2022-2026 Daniel Starke
 * @date 2022-04-20
 * @version 2026-06-08
 * 
...
constexpr const Encoding simCtrlMap[] = {
	{"FlightSimulationDevice"     , 0x01, UT_CA},
	...
	{"MotorcycleSimulationDevice" , 0x07, UT_CA},
...
constexpr const Encoding keyboardMap[] = {
	...
	{"ThousandsSeparator"         , 0xB2, UT_SEL},
...
constexpr const Encoding telDevMap[] = {
	...
	{"RedialablePhoneNumber"   , 0xF5, UT_OOC},
	...
	{"PhoneDateDay"            , 0x143, UT_DV},
	{"PhoneDateMonth"          , 0x144, UT_DV},
	{"PhoneDateYear"           , 0x145, UT_DV},
...
constexpr const Encoding consumerMap[] = {
	...
	{"AlCalendarSchedule"                    , 0x18E, UT_SEL},
	...
	{"AlOemFeaturesTipsTutorialBrowser"      , 0x1BD, UT_SEL},
	...
	{"AcSelectParagraph"                     , 0x274, UT_SEL},
	...
	{"AcNavigationGuidance"                  , 0x29E, UT_SEL},
	...
	{"ContactRecordActive"                   , 0x502, UT_OOC},
...
constexpr const Encoding sensorMap[] = {
	...
	{"MotionGravityVector"                           , 0x7B, UT_CA|UT_CP},
	...
	{"DataFieldGenericUnitOfMeasure"                 , 0x573, UT_NARY},
	...
	{"DataFieldHingeFoldContributingPanel"           , 0x5F4, UT_NARY},
	...
	{"SensorEventDataUpdated"                        , 0x813, UT_SEL},
	...
	{"HingeFoldContributingPanelUnknown"             , 0x9B0, UT_SEL},
	{"HingeFoldContributingPanelPanel1"              , 0x9B1, UT_SEL},
	{"HingeFoldContributingPanelPanel2"              , 0x9B2, UT_SEL},
	{"HingeFoldContributingPanelBoth"                , 0x9B3, UT_SEL},
...
constexpr const Encoding brailleMap[] = {
	...
	{"BrailleFaceControls"      , 0x20C, UT_NARY},
...
constexpr const Encoding lightMap[] = {
	...
	{"LampAttributesRequestReport"    , 0x20, UT_CL},
	{"LampId"                         , 0x21, UT_SV|UT_DV},
	{"LampAttributesResponseReport"   , 0x22, UT_CL},
...
constexpr const Encoding pwrDevMap[] = {
	...
	{"PowerConverter"     , 0x16, UT_CP},
	{"PowerConverterId"   , 0x17, UT_SV},
...
/**
 * HID descriptor usage battery system page encoding map.
 *
 * @see Usage Tables for HID Power Devices 1.0 ch. 4.2
 */
constexpr const Encoding batterySysMap[] = {
	{"SmbBatteryMode"             , 0x01, UT_CL},
	{"SmbBatteryStatus"           , 0x02, UT_CL},
	{"SmbAlarmWarning"            , 0x03, UT_CL},
	{"SmbChargerMode"             , 0x04, UT_CL},
	{"SmbChargerStatus"           , 0x05, UT_CL},
	{"SmbChargerSpecInfo"         , 0x06, UT_CL},
	{"SmbSelectorState"           , 0x07, UT_CL},
	{"SmbSelectorPresets"         , 0x08, UT_CL},
	{"SmbSelectorInfo"            , 0x09, UT_CL},
	{"OptionalMfgFunction1"       , 0x10, UT_DV},
	{"OptionalMfgFunction2"       , 0x11, UT_DV},
	{"OptionalMfgFunction3"       , 0x12, UT_DV},
	{"OptionalMfgFunction4"       , 0x13, UT_DV},
	{"OptionalMfgFunction5"       , 0x14, UT_DV},
	{"ConnectionToSmBus"          , 0x15, UT_DF},
	{"OutputConnection"           , 0x16, UT_DF},
	{"ChargerConnection"          , 0x17, UT_DF},
	{"BatteryInsertion"           , 0x18, UT_DF},
	{"UseNext"                    , 0x19, UT_DF},
	{"OkToUse"                    , 0x1A, UT_DF},
	{"BatterySupported"           , 0x1B, UT_DF},
	{"SelectorRevision"           , 0x1C, UT_DF},
	{"ChargingIndicator"          , 0x1D, UT_DF},
	{"ManufacturerAccess"         , 0x28, UT_DV},
	{"RemainingCapacityLimit"     , 0x29, UT_DV},
	{"RemainingTimeLimit"         , 0x2A, UT_DV},
	{"AtRate"                     , 0x2B, UT_DV},
	{"CapacityMode"               , 0x2C, UT_DV},
	{"BroadcastToCharger"         , 0x2D, UT_DV},
	{"PrimaryBattery"             , 0x2E, UT_DV},
	{"ChargeController"           , 0x2F, UT_DV},
	{"TerminateCharge"            , 0x40, UT_DF},
	{"TerminateDischarge"         , 0x41, UT_DF},
	{"BelowRemainingCapacityLimit", 0x42, UT_DF},
	{"RemainingTimeLimitExpired"  , 0x43, UT_DF},
	{"Charging"                   , 0x44, UT_DF},
	{"Discharging"                , 0x45, UT_DV},
	{"FullyCharged"               , 0x46, UT_DF},
	{"FullyDischarged"            , 0x47, UT_DV},
	{"ConditioningFlag"           , 0x48, UT_DV},
	{"AtRateOk"                   , 0x49, UT_DV},
	{"SmbErrorCode"               , 0x4A, UT_DF},
	{"NeedReplacement"            , 0x4B, UT_DF},
	{"AtRateTimeToFull"           , 0x60, UT_DV},
	{"AtRateTimeToEmpty"          , 0x61, UT_DV},
	{"AverageCurrent"             , 0x62, UT_DV},
	{"MaxError"                   , 0x63, UT_DV},
	{"RelativeStateOfCharge"      , 0x64, UT_DV},
	{"AbsoluteStateOfCharge"      , 0x65, UT_DV},
	{"RemainingCapacity"          , 0x66, UT_DV},
	{"FullChargeCapacity"         , 0x67, UT_DV},
	{"RunTimeToEmpty"             , 0x68, UT_DV},
	{"AverageTimeToEmpty"         , 0x69, UT_DV},
	{"AverageTimeToFull"          , 0x6A, UT_DV},
	{"CycleCount"                 , 0x6B, UT_DV},
	{"BattPackModelLevel"         , 0x80, UT_SV},
	{"InternalChargeController"   , 0x81, UT_SF},
	{"PrimaryBatterySupport"      , 0x82, UT_SF},
	{"DesignCapacity"             , 0x83, UT_SV},
	{"SpecificationInfo"          , 0x84, UT_SV},
	{"ManufacturerDate"           , 0x85, UT_SV},
	{"SerialNumber"               , 0x86, UT_SV},
	{"IManufacturerName"          , 0x87, UT_SV},
	{"IDevicename"                , 0x88, UT_SV},
	{"IDeviceChemistery"          , 0x89, UT_SV},
	{"ManufacturerData"           , 0x8A, UT_SV},
	{"Rechargable"                , 0x8B, UT_SV},
	{"WarningCapacityLimit"       , 0x8C, UT_SV},
	{"CapacityGranularity1"       , 0x8D, UT_SV},
	{"CapacityGranularity2"       , 0x8E, UT_SV},
	{"iOEMInformation"            , 0x8F, UT_SV},
	{"InhibitCharge"              , 0xC0, UT_DF},
	{"EnablePolling"              , 0xC1, UT_DF},
	{"ResetToZero"                , 0xC2, UT_DF},
	{"AcPresent"                  , 0xD0, UT_DF},
	{"BatteryPresent"             , 0xD1, UT_DF},
	{"PowerFail"                  , 0xD2, UT_DF},
	{"AlarmInhibited"             , 0xD3, UT_DF},
	{"ThermistorUnderRange"       , 0xD4, UT_DF},
	{"ThermistorHot"              , 0xD5, UT_DF},
	{"ThermistorCold"             , 0xD6, UT_DF},
	{"ThermistorOverRange"        , 0xD7, UT_DF},
	{"VoltageOutOfRange"          , 0xD8, UT_DF},
	{"CurrentOutOfRange"          , 0xD9, UT_DF},
	{"CurrentNotRegulated"        , 0xDA, UT_DF},
	{"VoltageNotRegulated"        , 0xDB, UT_DF},
	{"MasterMode"                 , 0xDC, UT_DF},
	{"ChargerSelectorSupport"     , 0xF0, UT_SF},
	{"ChargerSpec"                , 0xF1, UT_SV},
	{"Level2"                     , 0xF2, UT_SF},
	{"Level3"                     , 0xF3, UT_SF},
	endOfMap
};
...
constexpr const Encoding barcodeMap[] = {
	...
	{"GoodDecodeIndication"                      , 0x3A, UT_SF},
	...
	{"DecodeDataContinued"                       , 0xFF, UT_DF},
...
constexpr const Encoding arcadeMap[] = {
	...
	{"CoinDrawerStart"                 , 0x36, UT_OOC},
	{"CoinDrawerService"               , 0x37, UT_OOC},
	{"CoinDrawerTilt"                  , 0x38, UT_OOC},
...
constexpr const Encoding usagePageMap[] = {
	...
	{"MedicalInstrument"          , 0x40, medInstMap},
	...
	{"BatterySystem"              , 0x85, batterySysMap},
