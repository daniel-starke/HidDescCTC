...
${CXX} --version
${CXX} --sysroot=wasi-sysroot --target=wasm32-wasi -Dconstexpr= -O3 -nostdlib++ -nostartfiles -fno-exceptions -Wl,--no-entry -Wl,--export-dynamic -Wl,--import-memory -fvisibility=hidden -s -o HidWebCompiler.wasm HidWebCompiler.cpp || exit 1
